...
```
eclipsec -nosplash -clean -data C:\path\to\.refactoring-workspace -application io.github.nbauma109.refactoring.cli.app --source 21 --profile C:\path\to\source_cleanup_profile.xml C:\path\to\codebase_to_cleanup\
```
